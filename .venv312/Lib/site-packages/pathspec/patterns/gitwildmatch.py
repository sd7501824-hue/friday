...
from pathspec._typing import deprecated, override  # Added in 3.13.  # Added in 3.12.

from .gitignore.spec import GitIgnoreSpecPattern

# DEPRECATED: Deprecated since version 1.0.0. Expose GitWildMatchPatternError
# in this module for backward compatibility.
from .gitignore import GitIgnorePatternError as GitWildMatchPatternError
