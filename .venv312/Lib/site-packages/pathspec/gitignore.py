...
from pathspec._backends.agg import make_gitignore_backend
from pathspec.pathspec import PathSpec
from pathspec.pattern import Pattern
from pathspec.patterns.gitignore.basic import GitIgnoreBasicPattern
from pathspec.patterns.gitignore.spec import GitIgnoreSpecPattern
from pathspec._typing import AnyStr, override  # Removed in 3.18.  # Added in 3.12.
from pathspec.util import _is_iterable, lookup_pattern
    ...
    *gitignore* behavior. This is uses :class:`.GitIgnoreSpecPattern` to fully
    ...
    def from_lines(
        ...
        *backend* (:class:`str` or :data:`None`) is the pattern (regular expression)
        ...
        """
        if (isinstance(lines, (str, bytes)) or callable(lines)) and _is_iterable(
            pattern_factory
        ):
            # Support reversed order of arguments from PathSpec.
        ...
        self = super().from_lines(
            pattern_factory,
            lines,
            backend=backend,
            _test_backend_factory=_test_backend_factory,
        )
