...
class Picture(IDispatch):
    ...
    if TYPE_CHECKING:  # dispmembers
        ...
        def Render(
            self,
            hdc: hints.Incomplete,
            x: hints.Incomplete,
            y: hints.Incomplete,
            cx: hints.Incomplete,
            cy: hints.Incomplete,
            xSrc: hints.Incomplete,
            ySrc: hints.Incomplete,
            cxSrc: hints.Incomplete,
            cySrc: hints.Incomplete,
            prcWBounds: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
...
class IPicture(IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SelectPicture(
            self, hdcIn: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def _get_KeepOriginalFormat(self) -> hints.Incomplete: ...
        def _set_KeepOriginalFormat(
            self, pfkeep: hints.Incomplete
        ) -> hints.Hresult: ...

        KeepOriginalFormat = hints.normal_property(
            _get_KeepOriginalFormat, _set_KeepOriginalFormat
        )

        def PictureChanged(self) -> hints.Hresult: ...
        def SaveAsFile(
            self, pstm: hints.Incomplete, fSaveMemCopy: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class IFont(IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_Strikethrough(
            self, pstrikethrough: hints.Incomplete
        ) -> hints.Hresult: ...
        ...
        def SetRatio(
            self, cyLogical: hints.Incomplete, cyHimetric: hints.Incomplete
        ) -> hints.Hresult: ...
...
IFont._methods_ = [
    COMMETHOD(
        ['propget'], HRESULT, 'Name', (['out', 'retval'], POINTER(BSTR), 'pname')
    ),
    COMMETHOD(['propput'], HRESULT, 'Name', (['in'], BSTR, 'pname')),
    COMMETHOD(
        ['propget'], HRESULT, 'Size', (['out', 'retval'], POINTER(c_longlong), 'psize')
    ),
    COMMETHOD(['propput'], HRESULT, 'Size', (['in'], c_longlong, 'psize')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'Bold',
    ...
    COMMETHOD(['propput'], HRESULT, 'Bold', (['in'], VARIANT_BOOL, 'pbold')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'Italic',
    ...
    COMMETHOD(['propput'], HRESULT, 'Italic', (['in'], VARIANT_BOOL, 'pitalic')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'Underline',
    ...
    COMMETHOD(['propput'], HRESULT, 'Underline', (['in'], VARIANT_BOOL, 'punderline')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'Strikethrough',
    ...
    COMMETHOD(
        ['propget'], HRESULT, 'Weight', (['out', 'retval'], POINTER(c_short), 'pweight')
    ),
    COMMETHOD(['propput'], HRESULT, 'Weight', (['in'], c_short, 'pweight')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'Charset',
    ...
    COMMETHOD(['propput'], HRESULT, 'Charset', (['in'], c_short, 'pcharset')),
    COMMETHOD(
        ['propget'],
        HRESULT,
        'hFont',
    ...
    COMMETHOD([], HRESULT, 'Clone', (['out'], POINTER(POINTER(IFont)), 'ppfont')),
    COMMETHOD([], HRESULT, 'IsEqual', (['in'], POINTER(IFont), 'pfontOther')),
    COMMETHOD(
        [],
        HRESULT,
        'SetRatio',
    ...
    COMMETHOD([], HRESULT, 'AddRefHfont', (['in'], OLE_HANDLE, 'hFont')),
    COMMETHOD([], HRESULT, 'ReleaseHfont', (['in'], OLE_HANDLE, 'hFont')),
]
...
class FontEvents(IDispatch):
    ...
    if TYPE_CHECKING:  # dispmembers
        ...
        def FontChanged(
            self, PropertyName: hints.Incomplete, /
        ) -> hints.Incomplete: ...


FontEvents._disp_methods_ = [
    DISPMETHOD([dispid(9)], None, 'FontChanged', (['in'], BSTR, 'PropertyName')),
]
...
IPicture._methods_ = [
    ...
    COMMETHOD(
        ['propget'], HRESULT, 'hPal', (['out', 'retval'], POINTER(OLE_HANDLE), 'phpal')
    ),
    COMMETHOD(
        ['propget'], HRESULT, 'Type', (['out', 'retval'], POINTER(c_short), 'ptype')
    ),
    COMMETHOD(
        ['propget'],
        HRESULT,
    ...
    COMMETHOD(['propput'], HRESULT, 'hPal', (['in'], OLE_HANDLE, 'phpal')),
    COMMETHOD(
        ['propget'], HRESULT, 'CurDC', (['out', 'retval'], POINTER(c_int), 'phdcOut')
    ),
    COMMETHOD(
        [],
        HRESULT,
    ...
    COMMETHOD([], HRESULT, 'SetHdc', (['in'], OLE_HANDLE, 'hdc')),
]
