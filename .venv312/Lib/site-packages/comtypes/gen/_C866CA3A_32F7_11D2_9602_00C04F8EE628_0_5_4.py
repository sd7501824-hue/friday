...
from ctypes.wintypes import _FILETIME, _LARGE_INTEGER, _ULARGE_INTEGER, VARIANT_BOOL
...
class ISpResourceManager(IServiceProvider):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetObject(
            self, guidServiceId: hints.Incomplete, punkObject: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetObject(
            self,
            guidServiceId: hints.Incomplete,
            ObjectCLSID: hints.Incomplete,
            ObjectIID: hints.Incomplete,
            fReleaseWhenLastExternalRefReleased: hints.Incomplete,
        ) -> hints.Incomplete: ...
...
class ISpeechGrammarRules(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def Add(
            self,
            RuleName: hints.Incomplete,
            Attributes: hints.Incomplete,
            RuleId: hints.Incomplete = ...,
        ) -> 'ISpeechGrammarRule': ...
...
class ISpeechGrammarRule(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def AddResource(
            self, ResourceName: hints.Incomplete, ResourceValue: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpNotifySource(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetNotifyWindowMessage(
            self,
            hWnd: hints.Incomplete,
            Msg: hints.Incomplete,
            wParam: hints.Incomplete,
            lParam: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetNotifyCallbackFunction(
            self,
            pfnCallback: hints.Incomplete,
            wParam: hints.Incomplete,
            lParam: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetNotifyCallbackInterface(
            self,
            pSpCallback: hints.Incomplete,
            wParam: hints.Incomplete,
            lParam: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetNotifyWin32Event(self) -> hints.Hresult: ...
        def WaitForNotifyEvent(
            self, dwMilliseconds: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpEventSource(ISpNotifySource):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetInterest(
            self,
            ullEventInterest: hints.Incomplete,
            ullQueuedInterest: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetEvents(
            self, ulCount: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class ISpRecoContext(ISpEventSource):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetAudioOptions(
            ...
            pAudioFormatId: hints.Incomplete,
            pWaveFormatEx: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetAudioOptions(
            self, pOptions: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def DeserializeResult(
            self, pSerializedResult: hints.Incomplete
        ) -> 'ISpRecoResult': ...
        def Bookmark(
            self,
            Options: hints.Incomplete,
            ullStreamPosition: hints.Incomplete,
            lparamEvent: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetAdaptationData(
            self, pAdaptationData: hints.Incomplete, cch: hints.Incomplete
        ) -> hints.Hresult: ...
        def Pause(self, dwReserved: hints.Incomplete) -> hints.Hresult: ...
        def Resume(self, dwReserved: hints.Incomplete) -> hints.Hresult: ...
        def SetVoice(
            self, pVoice: hints.Incomplete, fAllowFormatChanges: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetVoice(self) -> 'ISpVoice': ...
        def SetVoicePurgeEvent(
            self, ullEventInterest: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpProperties(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetPropertyNum(
            self, pName: hints.Incomplete, lValue: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetPropertyNum(self, pName: hints.Incomplete) -> hints.Incomplete: ...
        def SetPropertyString(
            self, pName: hints.Incomplete, pValue: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpRecognizer(ISpProperties):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetInput(
            self, pUnkInput: hints.Incomplete, fAllowFormatChanges: hints.Incomplete
        ) -> hints.Hresult: ...
        ...
        def GetStatus(self) -> hints.Incomplete: ...
        def GetFormat(
            self, WaveFormatType: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def IsUISupported(
            self,
            pszTypeOfUI: hints.Incomplete,
            pvExtraData: hints.Incomplete,
            cbExtraData: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def DisplayUI(
            self,
            hWndParent: hints.Incomplete,
            pszTitle: hints.Incomplete,
            pszTypeOfUI: hints.Incomplete,
            pvExtraData: hints.Incomplete,
            cbExtraData: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpGrammarBuilder(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetRule(
            self,
            pszRuleName: hints.Incomplete,
            dwRuleId: hints.Incomplete,
            dwAttributes: hints.Incomplete,
            fCreateIfNotExist: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def ClearRule(self, hState: hints.Incomplete) -> hints.Hresult: ...
        def CreateNewState(self, hState: hints.Incomplete) -> hints.Incomplete: ...
        def AddWordTransition(
            self,
            hFromState: hints.Incomplete,
            hToState: hints.Incomplete,
            psz: hints.Incomplete,
            pszSeparators: hints.Incomplete,
            eWordType: hints.Incomplete,
            Weight: hints.Incomplete,
            pPropInfo: hints.Incomplete,
        ) -> hints.Hresult: ...
        def AddRuleTransition(
            self,
            hFromState: hints.Incomplete,
            hToState: hints.Incomplete,
            hRule: hints.Incomplete,
            Weight: hints.Incomplete,
            pPropInfo: hints.Incomplete,
        ) -> hints.Hresult: ...
        def AddResource(
            self,
            hRuleState: hints.Incomplete,
            pszResourceName: hints.Incomplete,
            pszResourceValue: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpRecoGrammar(ISpGrammarBuilder):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def LoadCmdFromFile(
            self, pszFileName: hints.Incomplete, Options: hints.Incomplete
        ) -> hints.Hresult: ...
        def LoadCmdFromObject(
            self,
            rcid: hints.Incomplete,
            pszGrammarName: hints.Incomplete,
            Options: hints.Incomplete,
        ) -> hints.Hresult: ...
        def LoadCmdFromResource(
            self,
            hModule: hints.Incomplete,
            pszResourceName: hints.Incomplete,
            pszResourceType: hints.Incomplete,
            wLanguage: hints.Incomplete,
            Options: hints.Incomplete,
        ) -> hints.Hresult: ...
        def LoadCmdFromMemory(
            self, pGrammar: hints.Incomplete, Options: hints.Incomplete
        ) -> hints.Hresult: ...
        def LoadCmdFromProprietaryGrammar(
            self,
            rguidParam: hints.Incomplete,
            pszStringParam: hints.Incomplete,
            pvDataPrarm: hints.Incomplete,
            cbDataSize: hints.Incomplete,
            Options: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetRuleState(
            self,
            pszName: hints.Incomplete,
            pReserved: hints.Incomplete,
            NewState: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetRuleIdState(
            self, ulRuleId: hints.Incomplete, NewState: hints.Incomplete
        ) -> hints.Hresult: ...
        def LoadDictation(
            self, pszTopicName: hints.Incomplete, Options: hints.Incomplete
        ) -> hints.Hresult: ...
        def UnloadDictation(self) -> hints.Hresult: ...
        def SetDictationState(self, NewState: hints.Incomplete) -> hints.Hresult: ...
        def SetWordSequenceData(
            self,
            pText: hints.Incomplete,
            cchText: hints.Incomplete,
            pInfo: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpPhrase(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetText(
            self,
            ulStart: hints.Incomplete,
            ulCount: hints.Incomplete,
            fUseTextReplacements: hints.Incomplete,
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class ISpRecoResult(ISpPhrase):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetAlternates(
            self,
            ulStartElement: hints.Incomplete,
            cElements: hints.Incomplete,
            ulRequestCount: hints.Incomplete,
        ) -> tuple['ISpPhraseAlt', hints.Incomplete]: ...
        def GetAudio(
            self, ulStartElement: hints.Incomplete, cElements: hints.Incomplete
        ) -> 'ISpStreamFormat': ...
        def SpeakAudio(
            self,
            ulStartElement: hints.Incomplete,
            cElements: hints.Incomplete,
            dwFlags: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def Serialize(self) -> hints.Incomplete: ...
        def ScaleAudio(
            self, pAudioFormatId: hints.Incomplete, pWaveFormatEx: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetRecoContext(self) -> 'ISpRecoContext': ...
...
class ISpVoice(ISpEventSource):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetOutput(
            self, pUnkOutput: hints.Incomplete, fAllowFormatChanges: hints.Incomplete
        ) -> hints.Hresult: ...
        ...
        def Speak(
            self, pwcs: hints.Incomplete, dwFlags: hints.Incomplete
        ) -> hints.Incomplete: ...
        def SpeakStream(
            self, pStream: hints.Incomplete, dwFlags: hints.Incomplete
        ) -> hints.Incomplete: ...
        def GetStatus(self) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def Skip(
            self, pItemType: hints.Incomplete, lNumItems: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class ISpeechRecoResult(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def Alternates(
            self,
            RequestCount: hints.Incomplete,
            StartElement: hints.Incomplete = ...,
            Elements: hints.Incomplete = ...,
        ) -> 'ISpeechPhraseAlternates': ...
        def Audio(
            self, StartElement: hints.Incomplete = ..., Elements: hints.Incomplete = ...
        ) -> 'ISpeechMemoryStream': ...
        def SpeakAudio(
            self,
            StartElement: hints.Incomplete = ...,
...
class ISpeechRecoContext(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        AudioInputInterferenceStatus = hints.normal_property(
            _get_AudioInputInterferenceStatus
        )
        ...
        def _set_AllowVoiceFormatMatchingOnNextSet(
            self, pAllow: hints.Incomplete
        ) -> hints.Hresult: ...

        AllowVoiceFormatMatchingOnNextSet = hints.normal_property(
            _get_AllowVoiceFormatMatchingOnNextSet,
            _set_AllowVoiceFormatMatchingOnNextSet,
        )

        def _get_VoicePurgeEvent(self) -> hints.Incomplete: ...
        def _set_VoicePurgeEvent(
            self, EventInterest: hints.Incomplete
        ) -> hints.Hresult: ...

        VoicePurgeEvent = hints.normal_property(
            _get_VoicePurgeEvent, _set_VoicePurgeEvent
        )

        def _get_EventInterests(self) -> hints.Incomplete: ...
        def _set_EventInterests(
            self, EventInterest: hints.Incomplete
        ) -> hints.Hresult: ...
        ...
        def _set_CmdMaxAlternates(
            self, MaxAlternates: hints.Incomplete
        ) -> hints.Hresult: ...

        CmdMaxAlternates = hints.normal_property(
            _get_CmdMaxAlternates, _set_CmdMaxAlternates
        )
        ...
        def _setref_RetainedAudioFormat(
            self, Format: hints.Incomplete
        ) -> hints.Hresult: ...

        RetainedAudioFormat = hints.normal_property(
            _get_RetainedAudioFormat, _setref_RetainedAudioFormat
        )

        def Pause(self) -> hints.Hresult: ...
        def Resume(self) -> hints.Hresult: ...
        def CreateGrammar(
            self, GrammarId: hints.Incomplete = ...
        ) -> 'ISpeechRecoGrammar': ...
        def CreateResultFromMemory(
            self, ResultBlock: hints.Incomplete
        ) -> 'ISpeechRecoResult': ...
        def Bookmark(
            self,
            Options: hints.Incomplete,
            StreamPos: hints.Incomplete,
            BookmarkId: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetAdaptationData(
            self, AdaptationString: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpeechAudioFormat(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetWaveFormatEx(
            self, SpeechWaveFormatEx: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpeechPhraseInfo(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetText(
            ...
            StartElement: hints.Incomplete = ...,
            Elements: hints.Incomplete = ...,
            UseReplacements: hints.Incomplete = ...,
        ) -> hints.Incomplete: ...
...
class ISpeechBaseStream(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def Read(
            self, NumberOfBytes: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def Write(self, Buffer: hints.Incomplete) -> hints.Incomplete: ...
        def Seek(
            self, Position: hints.Incomplete, Origin: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
...
class IStream(ISequentialStream):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def RemoteSeek(
            self, dlibMove: hints.Incomplete, dwOrigin: hints.Incomplete
        ) -> hints.Incomplete: ...
        def SetSize(self, libNewSize: hints.Incomplete) -> hints.Hresult: ...
        def RemoteCopyTo(
            self, pstm: hints.Incomplete, cb: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def Commit(self, grfCommitFlags: hints.Incomplete) -> hints.Hresult: ...
        def Revert(self) -> hints.Hresult: ...
        def LockRegion(
            self,
            libOffset: hints.Incomplete,
            cb: hints.Incomplete,
            dwLockType: hints.Incomplete,
        ) -> hints.Hresult: ...
        def UnlockRegion(
            self,
            libOffset: hints.Incomplete,
...
class ISpStreamFormatConverter(ISpStreamFormat):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetBaseStream(
            self,
            pStream: hints.Incomplete,
            fSetFormatToBaseStreamFormat: hints.Incomplete,
            fWriteToBaseStream: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetBaseStream(self) -> 'ISpStreamFormat': ...
        def SetFormat(
            self,
            rguidFormatIdOfConvertedStream: hints.Incomplete,
            pWaveFormatExOfConvertedStream: hints.Incomplete,
        ) -> hints.Hresult: ...
        def ResetSeekPosition(self) -> hints.Hresult: ...
        def ScaleConvertedToBaseOffset(
            self, ullOffsetConvertedStream: hints.Incomplete
        ) -> hints.Incomplete: ...
        def ScaleBaseToConvertedOffset(
            self, ullOffsetBaseStream: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class ISpeechGrammarRuleState(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def AddWordTransition(
            self,
            DestState: hints.Incomplete,
            Words: hints.Incomplete,
            Separators: hints.Incomplete = ...,
            Type: hints.Incomplete = ...,
            PropertyName: hints.Incomplete = ...,
            PropertyId: hints.Incomplete = ...,
            PropertyValue: hints.Incomplete = ...,
            Weight: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def AddRuleTransition(
            self,
            DestinationState: hints.Incomplete,
            Rule: hints.Incomplete,
            PropertyName: hints.Incomplete = ...,
            PropertyId: hints.Incomplete = ...,
            PropertyValue: hints.Incomplete = ...,
            Weight: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def AddSpecialTransition(
            self,
            DestinationState: hints.Incomplete,
            Type: hints.Incomplete,
            PropertyName: hints.Incomplete = ...,
...
class ISpDataKey(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetData(
            self,
            pszValueName: hints.Incomplete,
            cbData: hints.Incomplete,
            pData: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetData(
            self, pszValueName: hints.Incomplete, pcbData: hints.Incomplete
        ) -> hints.Incomplete: ...
        def SetStringValue(
            self, pszValueName: hints.Incomplete, pszValue: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetStringValue(
            self, pszValueName: hints.Incomplete
        ) -> hints.Incomplete: ...
        def SetDWORD(
            self, pszValueName: hints.Incomplete, dwValue: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpObjectToken(ISpDataKey):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetId(
            self,
            pszCategoryId: hints.Incomplete,
            pszTokenId: hints.Incomplete,
            fCreateIfNotExist: hints.Incomplete,
        ) -> hints.Hresult: ...
        ...
        def CreateInstance(
            self,
            pUnkOuter: hints.Incomplete,
            dwClsContext: hints.Incomplete,
            riid: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def GetStorageFileName(
            self,
            clsidCaller: hints.Incomplete,
            pszValueName: hints.Incomplete,
            pszFileNameSpecifier: hints.Incomplete,
            nFolder: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def RemoveStorageFileName(
            self,
            clsidCaller: hints.Incomplete,
            pszKeyName: hints.Incomplete,
            fDeleteFile: hints.Incomplete,
        ) -> hints.Hresult: ...
        ...
        def MatchesAttributes(
            self, pszAttributes: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class _ISpeechVoiceEvents(
    ...
    if TYPE_CHECKING:  # dispmembers
        ...
        def StartStream(
            self, StreamNumber: hints.Incomplete, StreamPosition: hints.Incomplete, /
        ) -> hints.Incomplete: ...
        def EndStream(
            self, StreamNumber: hints.Incomplete, StreamPosition: hints.Incomplete, /
        ) -> hints.Incomplete: ...
        def VoiceChange(
            self,
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            VoiceObjectToken: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def Bookmark(
            self,
        ...
        def Word(
            ...
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            CharacterPosition: hints.Incomplete,
            Length: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def Sentence(
            self,
        ...
        def Phoneme(
            ...
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            Duration: hints.Incomplete,
            NextPhoneId: hints.Incomplete,
            Feature: hints.Incomplete,
            CurrentPhoneId: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def Viseme(
            self,
            ...
            StreamPosition: hints.Incomplete,
            Duration: hints.Incomplete,
            NextVisemeId: hints.Incomplete,
            Feature: hints.Incomplete,
            CurrentVisemeId: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def AudioLevel(
            self,
...
class ISpeechObjectToken(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetDescription(
            self, Locale: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
        def SetId(
            self,
            Id: hints.Incomplete,
            CategoryID: hints.Incomplete = ...,
            CreateIfNotExist: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def GetAttribute(self, AttributeName: hints.Incomplete) -> hints.Incomplete: ...
        def CreateInstance(
            self, pUnkOuter: hints.Incomplete = ..., ClsContext: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
        def Remove(self, ObjectStorageCLSID: hints.Incomplete) -> hints.Hresult: ...
        def GetStorageFileName(
            self,
            ObjectStorageCLSID: hints.Incomplete,
            KeyName: hints.Incomplete,
            FileName: hints.Incomplete,
            Folder: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def RemoveStorageFileName(
            self,
            ObjectStorageCLSID: hints.Incomplete,
            KeyName: hints.Incomplete,
            DeleteFile: hints.Incomplete,
        ) -> hints.Hresult: ...
        def IsUISupported(
            self,
            TypeOfUI: hints.Incomplete,
            ExtraData: hints.Incomplete = ...,
            Object: hints.Incomplete = ...,
        ) -> hints.Incomplete: ...
        def DisplayUI(
            self,
            hWnd: hints.Incomplete,
        ...
        def MatchesAttributes(
            self, Attributes: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class ISpeechDataKey(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetBinaryValue(
            self, ValueName: hints.Incomplete, Value: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpeechRecognizer(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_AllowAudioInputFormatChangesOnNextSet(
            self, Allow: hints.Incomplete
        ) -> hints.Hresult: ...

        AllowAudioInputFormatChangesOnNextSet = hints.normal_property(
            _get_AllowAudioInputFormatChangesOnNextSet,
            _set_AllowAudioInputFormatChangesOnNextSet,
        )

        def _get_AudioInput(self) -> 'ISpeechObjectToken': ...
        def _setref_AudioInput(
            self, AudioInput: hints.Incomplete = ...
        ) -> hints.Hresult: ...

        AudioInput = hints.normal_property(_get_AudioInput, _setref_AudioInput)

        def _get_AudioInputStream(self) -> 'ISpeechBaseStream': ...
        def _setref_AudioInputStream(
            self, AudioInputStream: hints.Incomplete = ...
        ) -> hints.Hresult: ...

        AudioInputStream = hints.normal_property(
            _get_AudioInputStream, _setref_AudioInputStream
        )
        ...
        def EmulateRecognition(
            self,
            TextElements: hints.Incomplete,
            ElementDisplayAttributes: hints.Incomplete = ...,
        ...
        def SetPropertyNumber(
            self, Name: hints.Incomplete, Value: hints.Incomplete
        ) -> hints.Incomplete: ...
        ...
        def IsUISupported(
            self, TypeOfUI: hints.Incomplete, ExtraData: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
        def DisplayUI(
            self,
            hWndParent: hints.Incomplete,
        ...
        def GetRecognizers(
            self,
            RequiredAttributes: hints.Incomplete = ...,
            OptionalAttributes: hints.Incomplete = ...,
        ) -> 'ISpeechObjectTokens': ...
        def GetAudioInputs(
            self,
            RequiredAttributes: hints.Incomplete = ...,
...
class ISpeechVoice(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IDispatch):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _setref_AudioOutput(
            self, AudioOutput: hints.Incomplete
        ) -> hints.Hresult: ...

        AudioOutput = hints.normal_property(_get_AudioOutput, _setref_AudioOutput)

        def _get_AudioOutputStream(self) -> 'ISpeechBaseStream': ...
        def _setref_AudioOutputStream(
            self, AudioOutputStream: hints.Incomplete
        ) -> hints.Hresult: ...

        AudioOutputStream = hints.normal_property(
            _get_AudioOutputStream, _setref_AudioOutputStream
        )
        ...
        def _set_AllowAudioOutputFormatChangesOnNextSet(
            self, Allow: hints.Incomplete
        ) -> hints.Hresult: ...

        AllowAudioOutputFormatChangesOnNextSet = hints.normal_property(
            _get_AllowAudioOutputFormatChangesOnNextSet,
            _set_AllowAudioOutputFormatChangesOnNextSet,
        )

        def _get_EventInterests(self) -> hints.Incomplete: ...
        def _set_EventInterests(
            self, EventInterestFlags: hints.Incomplete
        ) -> hints.Hresult: ...
        ...
        def _set_SynchronousSpeakTimeout(
            self, msTimeout: hints.Incomplete
        ) -> hints.Hresult: ...

        SynchronousSpeakTimeout = hints.normal_property(
            _get_SynchronousSpeakTimeout, _set_SynchronousSpeakTimeout
        )

        def Speak(
            self, Text: hints.Incomplete, Flags: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
        def SpeakStream(
            self, Stream: hints.Incomplete, Flags: hints.Incomplete = ...
        ) -> hints.Incomplete: ...
        def Pause(self) -> hints.Hresult: ...
        def Resume(self) -> hints.Hresult: ...
        def Skip(
            self, Type: hints.Incomplete, NumItems: hints.Incomplete
        ) -> hints.Incomplete: ...
        def GetVoices(
            self,
            RequiredAttributes: hints.Incomplete = ...,
...
class ISpeechRecoGrammar(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def CmdLoadFromFile(
            self, FileName: hints.Incomplete, LoadOption: hints.Incomplete = ...
        ) -> hints.Hresult: ...
        def CmdLoadFromObject(
            self,
            ClassId: hints.Incomplete,
            GrammarName: hints.Incomplete,
            LoadOption: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def CmdLoadFromResource(
            self,
            hModule: hints.Incomplete,
            ResourceName: hints.Incomplete,
            ResourceType: hints.Incomplete,
            LanguageId: hints.Incomplete,
            LoadOption: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def CmdLoadFromMemory(
            self, GrammarData: hints.Incomplete, LoadOption: hints.Incomplete = ...
        ) -> hints.Hresult: ...
        def CmdLoadFromProprietaryGrammar(
            self,
            ProprietaryGuid: hints.Incomplete,
            ProprietaryString: hints.Incomplete,
            ProprietaryData: hints.Incomplete,
            LoadOption: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def CmdSetRuleState(
            self, Name: hints.Incomplete, State: hints.Incomplete
        ) -> hints.Hresult: ...
        def CmdSetRuleIdState(
            self, RuleId: hints.Incomplete, State: hints.Incomplete
        ) -> hints.Hresult: ...
        def DictationLoad(
            self, TopicName: hints.Incomplete = ..., LoadOption: hints.Incomplete = ...
        ) -> hints.Hresult: ...
        def DictationUnload(self) -> hints.Hresult: ...
        def DictationSetState(self, State: hints.Incomplete) -> hints.Hresult: ...
        def SetWordSequenceData(
            self,
            Text: hints.Incomplete,
            TextLength: hints.Incomplete,
            Info: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpeechObjectTokenCategory(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetId(
            self, Id: hints.Incomplete, CreateIfNotExist: hints.Incomplete = ...
        ) -> hints.Hresult: ...
...
class IEnumSpObjectTokens(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def Next(
            self, celt: hints.Incomplete
        ) -> tuple['ISpObjectToken', hints.Incomplete]: ...
        def Skip(self, celt: hints.Incomplete) -> hints.Hresult: ...
        def Reset(self) -> hints.Hresult: ...
...
class ISpeechAudio(ISpeechBaseStream):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_BufferNotifySize(
            self, BufferNotifySize: hints.Incomplete
        ) -> hints.Hresult: ...

        BufferNotifySize = hints.normal_property(
            _get_BufferNotifySize, _set_BufferNotifySize
        )
...
class ISpEventSink(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def AddEvents(
            self, pEventArray: hints.Incomplete, ulCount: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpAudio(ISpStreamFormat):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetState(
            self, NewState: hints.Incomplete, ullReserved: hints.Incomplete
        ) -> hints.Hresult: ...
        def SetFormat(
            self, rguidFmtId: hints.Incomplete, pWaveFormatEx: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetStatus(self) -> hints.Incomplete: ...
...
class ISpeechTextSelectionInformation(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_ActiveOffset(
            self, ActiveOffset: hints.Incomplete
        ) -> hints.Hresult: ...

        ActiveOffset = hints.normal_property(_get_ActiveOffset, _set_ActiveOffset)

        def _get_ActiveLength(self) -> hints.Incomplete: ...
        def _set_ActiveLength(
            self, ActiveLength: hints.Incomplete
        ) -> hints.Hresult: ...

        ActiveLength = hints.normal_property(_get_ActiveLength, _set_ActiveLength)

        def _get_SelectionOffset(self) -> hints.Incomplete: ...
        def _set_SelectionOffset(
            self, SelectionOffset: hints.Incomplete
        ) -> hints.Hresult: ...

        SelectionOffset = hints.normal_property(
            _get_SelectionOffset, _set_SelectionOffset
        )

        def _get_SelectionLength(self) -> hints.Incomplete: ...
        def _set_SelectionLength(
            self, SelectionLength: hints.Incomplete
        ) -> hints.Hresult: ...

        SelectionLength = hints.normal_property(
            _get_SelectionLength, _set_SelectionLength
        )
...
class _ISpeechRecoContextEvents(
    ...
    if TYPE_CHECKING:  # dispmembers
        ...
        def EndStream(
            ...
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            StreamReleased: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def Bookmark(
            self,
        ...
        def Recognition(
            ...
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            RecognitionType: hints.Incomplete,
            Result: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def Hypothesis(
            self,
        ...
        def PropertyNumberChange(
            self,
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            PropertyName: hints.Incomplete,
            NewNumberValue: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def PropertyStringChange(
            self,
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            PropertyName: hints.Incomplete,
            NewStringValue: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def FalseRecognition(
            self,
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            Result: hints.Incomplete,
        ...
        def RequestUI(
            ...
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            UIType: hints.Incomplete,
            /,
        ) -> hints.Incomplete: ...
        def RecognizerStateChange(
            self,
            StreamNumber: hints.Incomplete,
            StreamPosition: hints.Incomplete,
            NewState: hints.Incomplete,
        ...
        def RecognitionForOtherContext(
            self, StreamNumber: hints.Incomplete, StreamPosition: hints.Incomplete, /
        ) -> hints.Incomplete: ...
        def AudioLevel(
            self,
...
class ISpeechAudioBufferInfo(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_MinNotification(
            self, MinNotification: hints.Incomplete
        ) -> hints.Hresult: ...

        MinNotification = hints.normal_property(
            _get_MinNotification, _set_MinNotification
        )
...
class ISpeechWaveFormatEx(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _set_BitsPerSample(
            self, BitsPerSample: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpRecoContext2(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetGrammarOptions(
            self, eGrammarOptions: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetGrammarOptions(self) -> hints.Incomplete: ...
        def SetAdaptationData2(
            self,
            pAdaptationData: hints.Incomplete,
            cch: hints.Incomplete,
            pTopicName: hints.Incomplete,
            eAdaptationSettings: hints.Incomplete,
            eRelevance: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpRecognizer2(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def EmulateRecognitionEx(
            self, pPhrase: hints.Incomplete, dwCompareFlags: hints.Incomplete
        ) -> hints.Hresult: ...
        def SetTrainingState(
            self,
            fDoingTraining: hints.Incomplete,
            fAdaptFromTrainingData: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpSerializeState(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetSerializedState(
            self, dwReserved: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def SetSerializedState(
            self,
            pbData: hints.Incomplete,
            ulSize: hints.Incomplete,
            dwReserved: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpPhraseAlt(ISpPhrase):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetAltInfo(
            ...
            'ISpPhrase', hints.Incomplete, hints.Incomplete, hints.Incomplete
        ]: ...
        def Commit(self) -> hints.Hresult: ...
...
class ISpeechLexicon(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetWords(
            self, Flags: hints.Incomplete = ...
        ) -> tuple[hints.Incomplete, 'ISpeechLexiconWords']: ...
        def AddPronunciation(
            self,
            bstrWord: hints.Incomplete,
            LangId: hints.Incomplete,
            PartOfSpeech: hints.Incomplete = ...,
            bstrPronunciation: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def AddPronunciationByPhoneIds(
            self,
            bstrWord: hints.Incomplete,
            LangId: hints.Incomplete,
            PartOfSpeech: hints.Incomplete = ...,
            PhoneIds: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        ...
        def RemovePronunciationByPhoneIds(
            self,
            bstrWord: hints.Incomplete,
            LangId: hints.Incomplete,
            PartOfSpeech: hints.Incomplete = ...,
        ...
        def GetPronunciations(
            ...
            bstrWord: hints.Incomplete,
            LangId: hints.Incomplete = ...,
            TypeFlags: hints.Incomplete = ...,
        ) -> 'ISpeechLexiconPronunciations': ...
        def GetGenerationChange(
            self, GenerationId: hints.Incomplete
        ) -> tuple[hints.Incomplete, 'ISpeechLexiconWords']: ...
...
class ISpLexicon(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def GetPronunciations(
            self,
            pszWord: hints.Incomplete,
            LangId: hints.Incomplete,
            dwFlags: hints.Incomplete,
            pWordPronunciationList: hints.Incomplete,
        ) -> hints.Incomplete: ...
        def AddPronunciation(
            self,
            pszWord: hints.Incomplete,
            LangId: hints.Incomplete,
            ePartOfSpeech: hints.Incomplete,
            pszPronunciation: hints.Incomplete,
        ) -> hints.Hresult: ...
        def RemovePronunciation(
            self,
            pszWord: hints.Incomplete,
        ...
        def GetGenerationChange(
            self,
            dwFlags: hints.Incomplete,
            pdwGeneration: hints.Incomplete,
            pWordList: hints.Incomplete,
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetWords(
            self,
            dwFlags: hints.Incomplete,
            pdwGeneration: hints.Incomplete,
            pdwCookie: hints.Incomplete,
            pWordList: hints.Incomplete,
        ) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
...
class ISpStream(ISpStreamFormat):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetBaseStream(
            self,
            pStream: hints.Incomplete,
            rguidFormat: hints.Incomplete,
            pWaveFormatEx: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetBaseStream(self) -> 'IStream': ...
        def BindToFile(
            self,
            pszFileName: hints.Incomplete,
            eMode: hints.Incomplete,
            pFormatId: hints.Incomplete,
            pWaveFormatEx: hints.Incomplete,
            ullEventInterest: hints.Incomplete,
        ) -> hints.Hresult: ...
...
class ISpeechRecoResultDispatch(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetTextFeedback(
            self, Feedback: hints.Incomplete, WasSuccessful: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpNotifyTranslator(ISpNotifySink):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def InitWin32Event(
            self, hEvent: hints.Incomplete, fCloseHandleOnRelease: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpObjectTokenCategory(ISpDataKey):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SetId(
            self, pszCategoryId: hints.Incomplete, fCreateIfNotExist: hints.Incomplete
        ) -> hints.Hresult: ...
        def GetId(self) -> hints.Incomplete: ...
        def GetDataKey(self, spdkl: hints.Incomplete) -> 'ISpDataKey': ...
        def EnumTokens(
            self, pzsReqAttribs: hints.Incomplete, pszOptAttribs: hints.Incomplete
        ) -> 'IEnumSpObjectTokens': ...
...
class ISpShortcut(comtypes.gen._00020430_0000_0000_C000_000000000046_0_2_0.IUnknown):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def AddShortcut(
            self,
            pszDisplay: hints.Incomplete,
            LangId: hints.Incomplete,
            pszSpoken: hints.Incomplete,
            shType: hints.Incomplete,
        ) -> hints.Hresult: ...
        def RemoveShortcut(
            self,
            pszDisplay: hints.Incomplete,
        ...
        def GetShortcuts(
            self, LangId: hints.Incomplete, pShortcutpairList: hints.Incomplete
        ) -> hints.Incomplete: ...
        def GetGeneration(self) -> hints.Incomplete: ...
        def GetWordsFromGenerationChange(
            self, pdwGeneration: hints.Incomplete, pWordList: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def GetWords(
            self,
            pdwGeneration: hints.Incomplete,
        ...
        def GetShortcutsForGeneration(
            self,
            pdwGeneration: hints.Incomplete,
            pdwCookie: hints.Incomplete,
            pShortcutpairList: hints.Incomplete,
        ) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def GetGenerationChange(
            self, pdwGeneration: hints.Incomplete, pShortcutpairList: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
...
class ISpeechPhraseInfoBuilder(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def RestorePhraseFromMemory(
            self, PhraseInMemory: hints.Incomplete
        ) -> 'ISpeechPhraseInfo': ...
...
class ISpPhoneticAlphabetConverter(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def SAPI2UPS(
            self, pszSAPIId: hints.Incomplete, cMaxLength: hints.Incomplete
        ) -> hints.Incomplete: ...
        def UPS2SAPI(
            self, pszUPSId: hints.Incomplete, cMaxLength: hints.Incomplete
        ) -> hints.Incomplete: ...
        def GetMaxConvertLength(
            self, cSrcLength: hints.Incomplete, bSAPI2UPS: hints.Incomplete
        ) -> hints.Incomplete: ...
...
class ISpeechCustomStream(ISpeechBaseStream):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def _setref_BaseStream(
            self, ppUnkStream: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpeechFileStream(ISpeechBaseStream):
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def Open(
            self,
            FileName: hints.Incomplete,
            FileMode: hints.Incomplete = ...,
            DoEvents: hints.Incomplete = ...,
        ) -> hints.Hresult: ...
        def Close(self) -> hints.Hresult: ...
...
class ISpRecoGrammar2(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def LoadCmdFromFile2(
            self,
            pszFileName: hints.Incomplete,
            Options: hints.Incomplete,
            pszSharingUri: hints.Incomplete,
            pszBaseUri: hints.Incomplete,
        ) -> hints.Hresult: ...
        def LoadCmdFromMemory2(
            self,
            pGrammar: hints.Incomplete,
            Options: hints.Incomplete,
            pszSharingUri: hints.Incomplete,
            pszBaseUri: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetRulePriority(
            self,
            pszRuleName: hints.Incomplete,
            ulRuleId: hints.Incomplete,
            nRulePriority: hints.Incomplete,
        ) -> hints.Hresult: ...
        def SetRuleWeight(
            self,
            pszRuleName: hints.Incomplete,
            ulRuleId: hints.Incomplete,
            flWeight: hints.Incomplete,
        ) -> hints.Hresult: ...
        ...
        def SetSMLSecurityManager(
            self, pSMLSecurityManager: hints.Incomplete
        ) -> hints.Hresult: ...
...
class ISpeechResourceLoader(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def LoadResource(
            self, bstrResourceUri: hints.Incomplete, fAlwaysReload: hints.Incomplete
        ) -> tuple[
            hints.Incomplete, hints.Incomplete, hints.Incomplete, hints.Incomplete
        ]: ...
        def GetLocalCopy(
            self, bstrResourceUri: hints.Incomplete
        ) -> tuple[hints.Incomplete, hints.Incomplete, hints.Incomplete]: ...
        def ReleaseLocalCopy(
            self, pbstrLocalPath: hints.Incomplete
        ) -> hints.Hresult: ...
...
class IInternetSecurityManager(
    ...
    if TYPE_CHECKING:  # commembers
        ...
        def MapUrlToZone(
            self, pwszUrl: hints.Incomplete, dwFlags: hints.Incomplete
        ) -> hints.Incomplete: ...
        def GetSecurityId(
            self,
            pwszUrl: hints.Incomplete,
            pcbSecurityId: hints.Incomplete,
            dwReserved: hints.Incomplete,
        ) -> tuple[hints.Incomplete, hints.Incomplete]: ...
        def ProcessUrlAction(
            self,
            pwszUrl: hints.Incomplete,
            dwAction: hints.Incomplete,
            cbPolicy: hints.Incomplete,
            pContext: hints.Incomplete,
            cbContext: hints.Incomplete,
            dwFlags: hints.Incomplete,
            dwReserved: hints.Incomplete,
        ) -> hints.Incomplete: ...
        ...
        def SetZoneMapping(
            self,
            dwZone: hints.Incomplete,
            lpszPattern: hints.Incomplete,
            dwFlags: hints.Incomplete,
        ) -> hints.Hresult: ...
        def GetZoneMappings(
            self, dwZone: hints.Incomplete, dwFlags: hints.Incomplete
        ) -> 'IEnumString': ...
...
_check_version('1.4.16', 1775113511.705879)
